...
<body>
     <!-- Navigation -->
          ...
          <!-- Hero Section -->
          <section class="hero-gallery editable-image" style="background-image: url('fotosPrincipales/paradiso.jpg'); background-size: cover; background-position: center;">
                  ...
                  <section class="photo-grid">
                      <div class="grid-container">
                          <div class="photo-item large">
                              <img class="editable-image" src="fotosPrincipales/paradiso2.jpg" alt="Imagen principal">
                          ...
                          <div class="photo-item">
                              <img class="editable-image" src="fotosPrincipales/paradiso3.jpg" alt="Imagen 1">
                              <div class="photo-overlay">
                          ...
                          <div class="photo-item">
                              <img class="editable-image" src="fotosPrincipales/paradiso4.jpg" alt="Imagen 2">
                              <div class="photo-overlay">
                          ...
                          <div class="photo-item">
                              <img class="editable-image" src="fotosPrincipales/paradiso.jpg" alt="Imagen 3">
                              <div class="photo-overlay">
                          ...
                          <div class="photo-item">
                              <img class="editable-image" src="fotosPrincipales/paradiso2.jpg" alt="Imagen 4">
                              <div class="photo-overlay">
                          ...
                          <div class="photo-item">
                              <img class="editable-image" src="fotosPrincipales/paradiso3.jpg" alt="Imagen 5">
                              <div class="photo-overlay">
